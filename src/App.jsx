...
import { setGlobalAudioEnabled, stopNarration } from './utils/audio';
...
const STORAGE_KEY = 'intellia_division_grouping_v1';
  ...
  return (
    <>
      ...
      <div className="app-container">
        <button
          onClick={() => {
            setAudioEnabled((a) => {
              ...
              if (!next) stopNarration(); // stop any playing audio immediately on mute
              return next;
            });
          }}
        ...
        {phase !== 'intro' && (
          <div className="journey-bar">
            {PHASES.map((p, i) => (
              ...
              >
                <div className="journey-step-dot">{i < currentPhaseIndex ? '✓' : p.num}</div>
        ...
        {phase === 'intro' && (
          <IntroScreen onStart={() => setPhase('wonder')} audioEnabled={audioEnabled} />
        )}
        {phase === 'wonder' && (
